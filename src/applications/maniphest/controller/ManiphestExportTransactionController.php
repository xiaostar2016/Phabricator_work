...
final class ManiphestExportTransactionController extends ManiphestController
{
...
//        $ok = @include_once 'PHPExcel.php';
        ...
        $all_authored = mpull($tasks, 'getAuthorPHID');
        $handles = id(new PhabricatorHandleQuery())
            ->setViewer($viewer)
            ->withPHIDs(array_merge($all_projects, $all_assigned, $all_authored))
            ->execute();
